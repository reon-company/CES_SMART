...
- PM2로 서버 실행 중
- 포트 3000에서 리스닝 중
- API Health Check 성공: http://3.36.109.155:3000/api/health
...
### API 엔드포인트
- Health Check: `GET http://3.36.109.155:3000/api/health` ✅
- 회원가입: `POST http://3.36.109.155:3000/api/auth/register`
- 로그인: `POST http://3.36.109.155:3000/api/auth/login`
...
- `API_BASE_URL`: 이미 `http://3.36.109.155:3000`으로 설정됨 ✅
